define(['directives'],function(appDirectives){
	...
	var messageList = function($rootScope, $anchorScroll, MessageService, ngNotify){
 		return {
		    restrict: "E",
		    replace: true,
		    templateUrl: '../../../includes/messageList.html',
	...
	messageList.$inject = ['$rootScope', '$anchorScroll', 'MessageService', 'ngNotify'];
	appDirectives.directive('messageList',messageList); 
